      ...
      <div ref={contentRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 sm:py-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-12 sm:gap-16 mb-16">
          ...
          <div className="flex flex-col items-center text-center">
            <h4 className="font-[var(--font-heading)] text-xs font-bold text-white tracking-[0.2em] uppercase mb-6 flex flex-col items-center gap-3">
              Servicios
              <span className="w-8 h-[2px] bg-nb-green-primary/60" />
            </h4>
            <ul className="space-y-3">
              {FOOTER_SERVICES.map((svc) => (
                <li key={svc}>
                  <span className="text-sm text-nb-text-muted hover:text-nb-green-primary transition-colors duration-300 flex flex-col items-center gap-1 cursor-default group">
                    {svc}
                    <span className="w-0 h-[1px] bg-nb-green-primary/30 group-hover:w-4 transition-all duration-300" />
                  </span>
                </li>
              ))}
            </ul>
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="space-y-4">
              <motion.a
                ...
                whileHover={{ y: -2 }}
                className="flex items-center justify-center gap-3 text-sm text-nb-text-muted hover:text-nb-green-primary transition-colors duration-300"
              >
              ...
              <p className="text-sm text-nb-text-muted flex items-center justify-center gap-3">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="flex justify-center gap-4">
              {FOOTER_SOCIALS.map((social) => (
                <motion.a
                  ...
                  className="w-11 h-11 rounded-xl glass-card flex items-center justify-center text-nb-text-muted hover:text-nb-green-primary hover:border-nb-green-primary/50 transition-all duration-300"
                >
            ...
            <div className="mt-8 flex flex-col items-center">
              <p className="text-[10px] font-[var(--font-heading)] text-nb-text-muted/40 tracking-[0.2em] uppercase mb-4">
                Explorar
              </p>
