...
export const EVENT_CATEGORIES = [
  {
    ...
    description:
      "¿Aburrido de las mismas fiestas? Sube el nivel con nuestra Zona Gamer.",
  },
  {
    icon: "⚡",
    title: "Activaciones Épicas",
    description:
      "Atrae, impacta y conecta con tu audiencia a través de experiencias inmersivas.",
  },
  {
    icon: "🏢",
    title: "Eventos Corporativos",
    description:
      "Rompe el hielo. Team building y entretenimiento que tu equipo no olvidará.",
  },
  {
    icon: "🎂",
    title: "Cumpleaños Inolvidables",
    description:
      "Regala la mejor experiencia gaming. Desde niños hasta los más veteranos.",
  },
  {
    icon: "🎪",
    title: "Ferias y Festivales",
    description:
      "Conviértete en la principal atracción y roba todas las miradas.",
  },
];
...
export const EVENT_TYPES = [
  {
    ...
    description:
      "Siente la adrenalina del asfalto. Equipos Force Feedback para una inmersión total en la pista.",
    image: "/NB/images/simulador carro2.jpg",
  },
  {
    title: "Realidad Virtual (VR)",
    description:
      "Viaja a otros mundos. Ofrecemos experiencias VR alucinantes que dejarán sin palabras a tus invitados.",
    image: "/NB/images/simulador vr.jpg",
  },
  {
    title: "Arcade Clásico",
    description:
      "La nostalgia manda. Máquinas arcade multijuego para retar a tus amigos al estilo retro.",
    image: "/NB/images/arcade2.jpg",
  },
  {
    title: "Deportes / Futbolitos",
    description:
      "Competencia pura. Futbolitos profesionales y simuladores deportivos para calentar motores.",
...
export const TRUST_POINTS = [
  {
    ...
    description:
      "Solo utilizamos equipos de última generación. Cero lag, máxima diversión asegurada.",
  },
  {
    icon: "🛡️",
    title: "Tú Disfruta, Nosotros Armamos",
    description:
      "Olvídate del estrés. Hacemos el montaje y desmontaje completo de la Zona Gamer.",
  },
  {
    icon: "⚡",
    title: "Staff Técnico Especializado",
    description:
      "Nuestro equipo técnico estará presente para garantizar que todo funcione impecable.",
  },
  {
    icon: "🏆",
    title: "Experiencia Comprobada",
    description:
      "Respaldados por cientos de eventos exitosos. Tu evento está en manos de profesionales.",
  },
];
...
export const TESTIMONIALS = [
  {
    quote:
      "El montaje fue increíble. Nuestros invitados no paraban de jugar... tuvimos que literalmente terminar el evento para que se fueran. ¡Repetiremos seguro!",
    author: "María G.",
  ...
  {
    quote:
      "La zona gamer fue el hit de la fiesta de mi hijo. Todos los niños la pasaron genial, y los adultos también se engancharon jaja.",
    author: "Carlos R.",
    role: "Cumpleaños",
    rating: 5,
    avatarColor: "#2563EB",
  ...
  {
    quote:
      "Profesionales de primera. La activación tuvo una respuesta brutal del público. Superaron todas las expectativas.",
    author: "Ana M.",
  ...
  {
    quote:
      "10/10. El simulador de carreras fue un éxito total, la gente hacía fila para jugar. Muy buena organización desde el inicio.",
    author: "Jorge T.",
    role: "Fiesta Privada",
    rating: 5,
    avatarColor: "#D97706",
  ...
  {
    quote:
      "Honestamente no esperaba que fuera tan completo. Llegaron, montaron todo solos y lo dejaron perfecto. Cero estrés para mí.",
    author: "Patricia L.",
    role: "Quinceañera",
    rating: 5,
    avatarColor: "#059669",
  ...
  {
    quote:
      "Contratamos el paquete intermedio para nuestro team building y fue todo un acierto. El equipo de NB es muy profesional.",
    author: "Rodrigo V.",
  ...
  {
    quote:
      "El VR estuvo brutal. Mis amigos quedaron con la boca abierta. Vale cada peso.",
    author: "Sofía H.",
    role: "Graduación",
    rating: 5,
    avatarColor: "#BE185D",
